...
public class Character {
	...
	public String mirar() {
		return "Estas en un " +posicion.getName() + "." + "En el suelo hay "
				+ posicion.listarItems() + "." + "Hay un " + posicion.listarNpcs()
				+ posicion.listarConexiones() + ".";
	}
	...
	public void mover(String direccion) {
		...
		}else System.out.println("No es posible moverse a esa posicion");
	}


	public Connection hayConexion(String direccion) {
		for(Connection c: posicion.getConnections())
			if(c.getDirection().equals(direccion)) return c;
		return null;
	}
